import { generateSnowflakeString, generateSnowflakeBatch, deconstructSnowflake, validateSnowflake, Snowflake } from './index.js';
// 基本测试
console.log('=== 基本测试 ===');
...
try {
    ...
    // 手动设置一个很大的时间戳
    snowflakeInstance.lastTimestamp = BigInt(Date.now() + 10000);
